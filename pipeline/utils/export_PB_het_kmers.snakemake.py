...
print('head(ss_to_kmer_altkmer) =')
print_dict_head(ss_to_kmer_altkmer, 5)
print('head(ss_to_kmer_pos_and_interval) =')
print_dict_head(ss_to_kmer_pos_and_interval, 5)
print('head(ss_to_clust) =')
print_dict_head(ss_to_clust, 5)
...
print('head(lib_clust_to_haplo) =')
print_dict_head(lib_clust_to_haplo, 5)
...
print('len(pb_to_kmers) =', len(pb_to_kmers), 'len(pb_to_kmer_intervals) =', len(pb_to_kmer_intervals))
#print('head(pb_to_kmers) =')
#print(pb_to_kmers)
#print_dict_head(pb_to_kmers, 5)
#print('head(pb_to_kmer_intervals) =')
#print_dict_head(pb_to_kmer_intervals, 5)
